...
from app.config import MAX_RATING, MIN_RATING, MODEL_PATH, MODEL_VERSION
...
class MovieRatingModel:
    ...
    def _load_model(self) -> None:
        ...
        try:
            ...
            # TODO 1: Set MODEL_LOADED gauge to 1
    ...
    def predict(self, user_id: str, movie_id: str) -> float:
        ...
        try:
            ...
            # TODO 6: Calculate duration and record prediction count
